  ...
  useEffect(() => {
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        ...
        uResolution: { value: [container.offsetWidth, container.offsetHeight] as [number, number] },
        uBlend: { value: blend },
      },
    });
    ...
    const update = (t: number) => {
      ...
      const { time = t * 0.01, speed: liveSpeed = speed } = propsRef.current;
      program.uniforms.uTime.value = time * liveSpeed * 0.1;
