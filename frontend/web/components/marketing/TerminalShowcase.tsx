        ...
        <article className="grid border border-white/10 bg-black/85 md:grid-cols-2">
          <div className="border-b border-white/10 p-10 md:border-b-0 md:border-r">
            <h3 className="text-[56px] font-semibold leading-[0.95] tracking-tight text-white">
              Compare faster with
              <br />
              <span className="text-white/45">VEL Compare</span>
            </h3>
            <p className="mt-20 max-w-xl text-[20px] leading-relaxed text-white/75">
              Run the same prompt across top models, review differences, and pick the best response with confidence.
            </p>
            <button className="mt-8 rounded-full border border-white/25 px-7 py-2 text-sm tracking-[0.2em] text-white/80">TRY COMPARE ↗</button>
          </div>
          ...
          <div className="p-10 relative">
            <div className="mx-auto max-w-xl relative">
              ...
              <div className="mb-8 rounded-2xl border border-white/15 p-5">
                <div className="text-2xl font-semibold">Model Comparison Run</div>
                <div className="mt-4 flex items-center justify-between text-sm text-white/60">
                  <span className="text-emerald-300">● COMPLETE</span>
                  <span>RAN FOR 38 SECONDS</span>
                </div>
              </div>
              <div className="grid grid-cols-3 gap-4">
                {['GPT-4o', 'Claude', 'Gemini'].map((a, i) => (
